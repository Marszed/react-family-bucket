...
export default class Slider extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={this.props.className || 'Property_layoutImgbox_container'}
                ...
                {
                    count && this.props.tips !== false ? <span className="agency_img_index">{this.state.nowLocal + 1} 	&frasl; {this.state.items.length} P</span> : null
                }
            </div>
        );
    }
